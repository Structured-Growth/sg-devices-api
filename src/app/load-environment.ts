...
export function loadEnvironment() {
	...
	loader.loadAndValidate(process.env.__PATH_TO_ENV_FILE || ".env", {
		...
		DB_POOL_MAX: joi.number().allow(""),
		DB_POOL_MIN: joi.number().allow(""),
		DB_POOL_ACQUIRE: joi.number().allow(""),
		DB_POOL_IDLE: joi.number().allow(""),
		DB_POOL_EVICT: joi.number().allow(""),
		DB_POOL_MAX_USES: joi.number().allow(""),
