...
function generateDeviceCsvBuffer(count: number = 5): Buffer {
	const header =
		"accountId,userId,deviceCategoryId,deviceTypeId,manufacturer,modelNumber,serialNumber,imei,status,metadata.ieee,metadata.SA8SN,metadata.PCBAMfSN,metadata.calCode";
	const rows = [];
